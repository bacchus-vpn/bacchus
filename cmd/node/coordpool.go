...
// trimmed, deduped, order-preserving list of endpoints (old #6). The engine
...
// preserving first-seen order. Shared by the coordinator pool (old #6) and the
// transport pool (old #15).
